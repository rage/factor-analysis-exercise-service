...
test("can add factorial survey type wtih information elements and questions intermixed", async ({
  ...
  await page.frameLocator("iframe").locator("text=duplicate item").nth(1).click()
  // Click textarea >> nth=3
  await page.frameLocator("iframe").locator("textarea").nth(3).click()
  // Fill textarea >> nth=3
  await page.frameLocator("iframe").locator("textarea").nth(3).fill("death; Onko koira kuollut? *")
  // Select multiple-choice
  await page
    .frameLocator("iframe")
    .locator('[aria-label="select-answer-type-death"]')
    .selectOption("multiple-choice")
  // Check input[type="checkbox"] >> nth=2
  await page.frameLocator("iframe").locator('input[type="checkbox"]').nth(2).check()
  // Select ownership,Ei
  await page.frameLocator("iframe").locator("select").nth(3).selectOption("ownership,Ei")

  // Click text=Add Survey Item
  await page.frameLocator("iframe").locator("text=Add Survey Item").click()
  // Click textarea >> nth=4
  await page.frameLocator("iframe").locator("textarea").nth(4).click()
  // Fill textarea >> nth=4
  await page
    .frameLocator("iframe")
    .locator("textarea")
    .nth(4)
    .fill("date_of_death; Koiran kuolinaika (PP.KK.VVVV)")
  // Select date
  await page
    .frameLocator("iframe")
    .locator('[aria-label="select-answer-type-date_of_death"]')
    .selectOption("date")
  // Check input[type="checkbox"] >> nth=3
  await page.frameLocator("iframe").locator('input[type="checkbox"]').nth(3).check()
  // Select death,Kyllä
  await page
    .frameLocator("iframe")
  ...
  await page
    .frameLocator("iframe")
    .locator('[aria-label="select-answer-type-breed"]')
    .selectOption("breed-list")
  // Click text=Add Survey Item
  await page.frameLocator("iframe").locator("text=Add Survey Item").click()
  ...
  await page.frameLocator("iframe").locator("text=add option").nth(2).click()
  ...
  await page.frameLocator("iframe").locator('[aria-label="\\32 -option-text"]').click()
  // Fill [aria-label="\32 -option-text"]
  await page.frameLocator("iframe").locator('[aria-label="\\32 -option-text"]').fill("muu")
  ...
  await page
    .frameLocator("iframe")
    .locator('[aria-label="select-answer-type-socialization_car"]')
    .selectOption("number")

  // Check text=infoSosiaalistamiskausi: 7 viikon - 4 kuukauden iässä, miten usein koira... xEdi >> input[type="checkbox"]
  await page
    .frameLocator("iframe")
    .locator('text=socialization_carmatkusti autolla? * >> input[type="checkbox"]')
    .check()
